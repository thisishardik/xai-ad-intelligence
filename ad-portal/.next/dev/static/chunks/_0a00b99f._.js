    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (formData.adImage) {
                ...
                const { data: img, error: imgErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('ad-images').upload(filePath, file);
                if (imgErr) {
                ...
                const { data: urlData } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('ad-images').getPublicUrl(img.path);
                imageUrl = urlData.publicUrl;
            }
            // 2) Insert metadata into ad_campaigns table
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('ad_campaigns').insert({
            ...
            if (error instanceof Error && ("TURBOPACK compile-time value", "object") !== 'undefined') {
...
_s(AdSubmissionForm, "zMWZ3fhyKnN46OB816vogQHhrnc=");
_c = AdSubmissionForm;
var _c;
...
//# sourceMappingURL=_0a00b99f._.js.map