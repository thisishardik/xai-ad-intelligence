    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (formData.adImage) {
                ...
                const { error: uploadError, data: uploadData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('ad-images').upload(filePath, formData.adImage, {
                    cacheControl: '3600',
                    upsert: false
                });
                if (uploadError) {
                ...
                const { data: urlData } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('ad-images').getPublicUrl(filePath);
                imageUrl = urlData.publicUrl;
            }
            // Insert campaign data into database
            const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('campaigns').insert([
                {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab8cd364._.js.map